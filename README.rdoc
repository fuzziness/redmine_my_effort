...
== Compatibility
This plugin is tested with the trunk version fo redmine. If you are sucessfully using it with other versions, please "report it to me":http://github.com/benfante.
